...
#define DELTA
  ...
  #define DELTA_HEIGHT 232.05             // (mm) Get this value from G33 auto calibrate
  ...
  #define DELTA_TOWER_ANGLE_TRIM { -0.38, -0.38, +0.76 } // Get these values from G33 auto calibrate
