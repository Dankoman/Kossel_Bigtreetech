...
#define DELTA
  ...
  #define DELTA_SEGMENTS_PER_SECOND 200 //80
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_PRINTABLE_RADIUS 120.0//115.0  // (mm)
    ...
    #define DELTA_RADIUS 132.15 //(DELTA_SMOOTH_ROD_OFFSET-(DELTA_EFFECTOR_OFFSET)-(DELTA_CARRIAGE_OFFSET))          // (mm) Get this value from G33 auto calibrate
  #else
    // Print surface diameter/2 minus unreachable space (avoid collisions with vertical towers).
  ...
  #define DELTA_HEIGHT 245.64             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { -3.84, -0.94, 0.00 } // Get these values from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 0.72, -0.45, -0.27 } // Get these values from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 113 }  // default steps per unit for Kossel (GT2, 20 tooth)
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_HOTEND_TEMP  218    // (°C) Default nozzle temperature for the G26 Mesh Validation Tool.
